...
public class LocalAgentsBuilder(ILogger<LocalAgentsBuilder> logger, IChatClient chatClient) : IAgentBuilder
{
    ...
    protected Kernel CreateKernelWithChatCompletion()
    {
        ...
        chatClient = AddChatClientToKernel(builder, chatClient);
        return builder.Build();
    }



    protected IChatClient AddChatClientToKernel(IKernelBuilder builder, IChatClient chatClient)
    {
